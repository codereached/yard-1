  ...
  module Handlers
    ...
    module Ruby # All Ruby handlers
      ...
      module ReferenceHandlers
        ...
        autoload :VarRefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :TopConstRefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :ClassDefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :ModuleDefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :MethodDefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :MethodDefsHandler,        __p('handlers/ruby/reference_handlers')
        autoload :CallRefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :VFCallRefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :ConstPathRefHandler,        __p('handlers/ruby/reference_handlers')
        autoload :NodeTraverser,        __p('handlers/ruby/reference_handlers')
      end
